...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	@Override
	public byte[] gerarBoleto(com.algaworks.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	private Boleto criarBoleto(com.algaworks.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
		...
		boleto.setLocalPagamento("Pagável em qualquer agência bancária até a data de vencimento");
		boleto.setInstrucao1("Não receber após o vencimento");
		return boleto;
	}

	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado,
			org.jrimum.domkee.financeiro.banco.febraban.Cedente cedente, Cobranca cobrancaSistema) {
